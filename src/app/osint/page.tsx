...
const ACCENT  = '#0891B2';
const IMG_URL = 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=1400&q=80&auto=format&fit=crop';
const IMG_POS = 'center 50%';
const DESC    = 'OSINT · Cybersécurité · Renseignement · Intelligence numérique';
